...
# ==============================================================================
class Config:
    VERSION = "V7.6 PRODUCTION DEPLOYED (7 SENSORS & MASTER PANEL DB)" 
    MASTER_DB_FILE = "Master_Stock_Database.xlsx"

class Utils:
    @staticmethod
    def get_vn_time():
        # Ép chuẩn múi giờ GMT+7 Việt Nam
        return datetime.utcnow() + timedelta(hours=7)

# ==============================================================================
# 📈 BLOCK 2: CHỨNG KHOÁN QUANT ENGINE (7 SIÊU CẢM BIẾN & 3 LÕI PHÂN TÍCH)
# ==============================================================================
...
# ==============================================================================
def create_ui():
    with gr.Blocks(title="STOCK QUANT ENGINE V7.6", theme=gr.themes.Default(primary_hue="orange")) as demo:
        gr.Markdown(f"# 🚀 PRO STOCK QUANT ENGINE {Config.VERSION}")
        gr.Markdown(f"**Trạng thái Múi Giờ:** GMT+7 (Hà Nội) | **Cấu hình:** Production Deployed")
...
if __name__ == '__main__':
    demo = create_ui()
    # Tự động bắt đúng Port dynamic từ Render để tránh lỗi Deploy
