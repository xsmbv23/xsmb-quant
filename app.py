...
# ==============================================================================
# 🧬 LÕI QUANT V12.0 - TÍCH HỢP V11 CORE RECONCILIATION ENGINE
# ==============================================================================
VERSION = "V12.0 RECONCILED QUANT ENGINE"
DATA_FILE = "Ket_Qua_Loto27.xlsx"

# ------------------------------------------------------------------------------
# 📐 CLASS 1: V11 CORE ENGINE (HIERARCHICAL RECONCILIATION & CROSS-TESTING)
# ------------------------------------------------------------------------------
class V11CoreEngine:
    """
    Lõi V11: Hệ thống dự đoán và tích lũy dữ liệu tự động, 
    tuân thủ nghiêm ngặt Hierarchical Reconciliation và Cross-Testing.
    """
    def __init__(self, S_matrix: np.ndarray, tolerance: float = 1e-6):
        self.S = S_matrix
        self.tolerance = tolerance
        # Khởi tạo ma trận chiếu Bottom-Up: P = (S^T * S)^(-1) * S^T
...
def web_phan_he_1_sync():
    ...
    # Giả lập ma trận cấu trúc S (Total = Sum of Bottom 2)
    S_matrix = np.array([[1, 1], [1, 0], [0, 1]])
    engine_v11 = V11CoreEngine(S_matrix)
    
    # Tạo dữ liệu giả định 5 ngày để chạy thử nghiệm Self-Healing Pipeline
...
# ==============================================================================
# 🎨 GIAO DIỆN GRADIO V12.0
# ==============================================================================
_, INITIAL_NEXT_DATE = lay_thoi_gian_thuc_vn()

with gr.Blocks(title="XSMB QUANT ENGINE V12.0") as demo:
    gr.Markdown("# 🚀 XSMB QUANT ENGINE V12.0 — V11 RECONCILIATION INTEGRATED")
